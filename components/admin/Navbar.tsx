  ...
  return (
    <div
      className={`h-screen w-fit sm:min-w-[260px] 
            ...
            ${mode === "light" ? "bg-[#ebebeb]" : "bg-[#3e3e3e]"} z-50`}
    >
      <div
      ...
      >
        ...
        <div className="flex flex-col gap-5 items-center sm:items-start">
          <div
            ...
            items-center gap-1 font-semibold flex-col sm:flex-row`}
          >
            <FaHome size={24} />
            <div className="text-xs sm:text-lg">Home</div>
          </div>
          ...
          >
            <IoMdPerson size={24} />
            <div className="text-xs sm:text-lg">Users</div>
          </div>
          ...
          >
            <MdPayment size={24} />
            <div className="text-xs sm:text-lg">Transactions</div>
          </div>
          ...
          <div
            ...
            gap-1 font-semibold flex-col sm:flex-row`}
          >
            <FaCreditCard size={24} />
            <div className="text-xs sm:text-lg">Cards</div>
          </div>
          ...
          >
            <FaWallet size={24} />
            <div className="text-xs sm:text-lg">Wallets</div>
          </div>
              ...
              <Accordion.Panel>
                <div className="flex flex-col gap-4 items-center sm:items-start">
                  <div
                    ...
                    gap-2 font-semibold flex-col sm:flex-row`}
                  >
                    <FaCoins size={20} />
                    <div className="text-xs sm:text-lg">Coins</div>
                  </div>
                  ...
                  >
                    ...
                    <div className="text-xs sm:text-lg">Plans</div>
                  </div>
                  ...
                  >
                    <FaPiggyBank size={20} />
                    <div className="text-xs sm:text-lg">Invests</div>
                  </div>
                  ...
                  >
                    <FaBuilding size={20} />
                    <div className="text-xs sm:text-lg">Company</div>
                  </div>
                </div>
              </Accordion.Panel>
            </Accordion.Item>
